...
import pregaImg from '../assests/pregantwomen.png'
export default function CradleCare() {
  ...
  return (
    <div className="desktop-container">
      ...
      <Slidebar/>
      <img src={pregaImg} className="pregaImg" alt="" />
        <h1>Cradle Care 💕</h1>
        <p>{"Baby's"} Arrival Countdown</p>
        <p className="countdown">365 Days Left</p>
      </div>

      {/* KYC & Subscription */}
      <div className="info-section">
        <div className="kyc-status" onClick={() => navigate("/KYC")}>
          <br />
          <a className="kyc-title" >KYC Status:</a>
          <p className="pending">Pending</p>
        </div>
        <div className="motherhood-prime">
          <p className="prime-title">Motherhood Prime</p>
          <p>Elevate your pregnancy experience</p>
          <button className="start-btn" onClick={()=>navigate("/pay")}>Start Now</button>
        </div>
      </div>
